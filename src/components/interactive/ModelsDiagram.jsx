...
const MODELS = [
  ...
  },
  {
    ...
    color: '#a78bfa',
    badge: null,
    description: 'Opus-tier analysis with 200K context. Use for Opus-level tasks that do not require the 1M context window of Opus 4.7/4.8.',
    bestFor: ['Long document analysis', 'Comprehensive reviews', 'Heavy analysis tasks', 'Opus tasks under 200K tokens'],
    notFor: ['Whole-codebase analysis (use Opus 4.7)', 'Bulk operations', 'Quick tasks'],
  },
  {
