...
// ── GROUND-TRUTH MODEL DATA (June 7, 2026 · v2.1.126) ──────────────────────────────────
const MODELS = {
  // Opus 4.7 and 4.8 → 1M context; Opus 4.6, Sonnet 4.6, Haiku 4.5 → 200K context
  // All Opus models share same $15/$75 pricing tier
  "opus-4-8": {
    label:"Claude Opus 4.8 (Newest)",
    short:"Opus 4.8",
    ctx:1000000,
    maxOut:128000,
    inPrice:15.00,
    ...
    thinking:true,
    xhigh:true,
    desc:"Newest, most capable model. Holds the 'opus' alias. 1M context. Frontier reasoning, novel architecture, hardest problems where quality is paramount.",
    bestFor:"Hardest 5% of problems, frontier reasoning",
    color:"#9B59B6",
  },
  "opus-4-7": {
    ...
    thinking:true,
    xhigh:true,
    desc:"Highly capable with 1M context window. Default xhigh effort. Complex reasoning, architecture decisions, large codebase analysis.",
    bestFor:"Complex agentic work, architecture, xhigh effort tasks",
    color:"#0F6E56",
  },
  "opus-4-6": {
    ...
    thinking:true,
    xhigh:false,
    desc:"Opus-tier capability with 200K context. Use for Opus-level tasks that don't require the 1M context window of Opus 4.7/4.8.",
    bestFor:"Opus tasks under 200K tokens, document analysis",
    color:"#185FA5",
  },
  "sonnet-4-6": {
    ...
    thinking:true,
    xhigh:false,
    desc:"Best balance of speed and intelligence. 200K context. Holds the 'sonnet' alias. Default model for most Claude Code sessions. Handles ~90% of coding tasks at 5× lower input cost than Opus.",
    bestFor:"Daily coding, most tasks — recommended daily driver",
    color:"#534AB7",
  },
  "haiku-4-5": {
    ...
    thinking:true,
    xhigh:false,
    desc:"Fastest, most cost-efficient model. 200K context. Holds the 'haiku' alias. Best for mechanical, fast, cheap tasks — subagents, CI/CD, bulk operations.",
    bestFor:"CI/CD pipelines, subagents, bulk operations, formatting",
    color:"#1D9E75",
  },
}
