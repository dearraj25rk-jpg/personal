import{j as e}from"./jsx-runtime.u17CrQMm.js";import{r as u}from"./index.B02hbnpo.js";const m=[{id:"loop",label:"🔄 Agentic Loop"},{id:"stop",label:"🛑 stop_reason Map"},{id:"multi",label:"🏗️ Multi-Agent"},{id:"context",label:"📦 Context Passing"},{id:"hooks",label:"⚡ Hooks System"},{id:"enforce",label:"🔒 Enforcement"},{id:"decomp",label:"✂️ Decomposition"},{id:"session",label:"💾 Sessions"},{id:"anti",label:"⚠️ Anti-Patterns"}];function l({title:o,children:s,color:i="#3B82F6"}){return e.jsxs("div",{style:{marginBottom:20},children:[e.jsx("h3",{style:{margin:"0 0 12px",fontSize:16,fontWeight:700,color:"#e0e0e0",borderBottom:`3px solid ${i}`,paddingBottom:6,display:"inline-block"},children:o}),s]})}function a({type:o,children:s}){const i={exam:{bg:"rgba(245,158,11,0.08)",border:"#F59E0B",icon:"🎯",label:"EXAM TIP"},correct:{bg:"rgba(34,197,94,0.08)",border:"#22C55E",icon:"✅",label:"CORRECT"},wrong:{bg:"rgba(239,68,68,0.08)",border:"#EF4444",icon:"❌",label:"WRONG"},key:{bg:"rgba(59,130,246,0.08)",border:"#3B82F6",icon:"💡",label:"KEY CONCEPT"},code:{bg:"rgba(100,116,139,0.08)",border:"#64748B",icon:"💻",label:"CODE"},warn:{bg:"rgba(249,115,22,0.08)",border:"#F97316",icon:"⚠️",label:"WARNING"}},t=i[o]||i.key;return e.jsxs("div",{style:{padding:12,background:t.bg,border:`1px solid ${t.border}44`,borderLeft:`4px solid ${t.border}`,borderRadius:"0 8px 8px 0",marginBottom:10},children:[e.jsxs("div",{style:{fontSize:11,fontWeight:700,color:t.border,marginBottom:4},children:[t.icon," ",t.label]}),e.jsx("div",{style:{fontSize:13,lineHeight:1.6,color:"#cbd5e1"},children:s})]})}function c({children:o}){return e.jsx("pre",{style:{background:"#1E293B",color:"#A5F3FC",borderRadius:8,padding:12,fontSize:11.5,lineHeight:1.5,overflow:"auto",margin:"8px 0"},children:o})}function g({steps:o}){const[s,i]=u.useState(0);return e.jsxs("div",{children:[e.jsx("div",{style:{display:"flex",gap:4,marginBottom:12,flexWrap:"wrap"},children:o.map((t,n)=>e.jsx("button",{onClick:()=>i(n),style:{padding:"6px 12px",borderRadius:8,fontSize:12,fontWeight:600,cursor:"pointer",border:`2px solid ${n===s?t.color||"#3B82F6":"rgba(255,255,255,0.12)"}`,background:n===s?(t.color||"#3B82F6")+"20":"#161b22",color:n===s?t.color||"#60a5fa":"#9ba8b0"},children:t.label},n))}),e.jsxs("div",{style:{background:"#161b22",borderRadius:12,padding:16,border:`1px solid ${o[s].color||"#3B82F6"}33`,minHeight:120},children:[e.jsx("div",{style:{fontSize:15,fontWeight:700,color:"#e0e0e0",marginBottom:8},children:o[s].title}),e.jsx("div",{style:{fontSize:13,lineHeight:1.7,color:"#9ba8b0"},children:o[s].content}),o[s].code&&e.jsx(c,{children:o[s].code})]})]})}function h(){const[o,s]=u.useState(0),[i,t]=u.useState(!1),n=[{label:"1️⃣ Send",title:"Step 1: Send Prompt + Tools to Claude",color:"#3B82F6",content:"Your code sends the user's message along with tool definitions to the Claude API. On the first iteration, messages contains just the user message. On subsequent iterations, it contains the full conversation history including all prior tool calls and results.",code:`# Python
...
# Loop back → Claude sees everything`}];u.useEffect(()=>{if(!i)return;const p=setInterval(()=>s(d=>(d+1)%n.length),4e3);return()=>clearInterval(p)},[i,n.length]);const r=n[o];return e.jsxs("div",{children:[e.jsxs(l,{title:"The Agentic Loop — Complete Animated Walkthrough",children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12},children:[e.jsxs("div",{style:{display:"flex",gap:4},children:[e.jsx("button",{onClick:()=>s(Math.max(0,o-1)),style:{padding:"4px 10px",borderRadius:6,border:"1px solid rgba(255,255,255,0.12)",background:"#161b22",cursor:"pointer",fontSize:12},children:"← Prev"}),e.jsx("button",{onClick:()=>t(!i),style:{padding:"4px 10px",borderRadius:6,border:"none",background:i?"#EF4444":"#3B82F6",color:"white",cursor:"pointer",fontSize:12},children:i?"⏸ Pause":"▶ Auto-Play"}),e.jsx("button",{onClick:()=>s((o+1)%n.length),style:{padding:"4px 10px",borderRadius:6,border:"1px solid rgba(255,255,255,0.12)",background:"#161b22",cursor:"pointer",fontSize:12},children:"Next →"})]}),e.jsxs("div",{style:{fontSize:12,color:"#94A3B8"},children:["Step ",o+1," of ",n.length]})]}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(6, 1fr)",gap:4,marginBottom:12},children:n.map((p,d)=>e.jsx("button",{onClick:()=>s(d),style:{padding:"8px 4px",borderRadius:8,fontSize:11,fontWeight:600,cursor:"pointer",border:`2px solid ${d===o?p.color:"rgba(255,255,255,0.12)"}`,background:d===o?p.color+"15":d<o?"rgba(34,197,94,0.08)":"#161b22",color:d===o?p.color:"#9ba8b0",transition:"all 0.3s",transform:d===o?"scale(1.05)":"scale(1)",boxShadow:d===o?`0 2px 8px ${p.color}33`:"none"},children:p.label},d))}),e.jsxs("div",{style:{background:r.color+"08",borderRadius:12,padding:16,border:`2px solid ${r.color}33`,transition:"all 0.3s"},children:[e.jsx("div",{style:{fontSize:15,fontWeight:700,color:r.color,marginBottom:8},children:r.title}),e.jsx("div",{style:{fontSize:13,lineHeight:1.7,color:"#9ba8b0",marginBottom:8},children:r.content}),e.jsx(c,{children:r.code})]})]}),e.jsx(a,{type:"key",children:'The complete loop in one sentence: Send prompt → Claude responds → Check stop_reason → If "tool_use": execute tools, append results as user message, loop back → If "end_turn": return text, done.'}),e.jsxs(l,{title:"Agent SDK Version (Simplified)",children:[e.jsx("div",{style:{fontSize:13,lineHeight:1.6,color:"#9ba8b0",marginBottom:8},children:"The Claude Agent SDK abstracts the raw loop. You consume a stream of messages — the SDK handles tool execution, context management, and retries internally."}),e.jsx(c,{children:`# Python Agent SDK
...
response = client.messages.create(
    ...
    ...
)`}];return e.jsxs(l,{title:"Complete stop_reason Reference Map",children:[e.jsx("div",{style:{fontSize:13,color:"#9ba8b0",marginBottom:12},children:"Click each stop_reason to see its full details, code handling, and exam relevance."}),e.jsx("div",{style:{display:"grid",gap:6},children:i.map((t,n)=>e.jsxs("div",{children:[e.jsxs("button",{onClick:()=>s(o===n?null:n),style:{width:"100%",display:"flex",alignItems:"center",gap:10,padding:"10px 14px",borderRadius:10,cursor:"pointer",textAlign:"left",border:`2px solid ${o===n?t.color:t.color+"33"}`,background:o===n?t.color+"10":"#161b22",transition:"all 0.2s"},children:[e.jsx("span",{style:{fontSize:18},children:t.icon}),e.jsxs("code",{style:{fontSize:13,fontWeight:700,color:t.color,minWidth:120},children:['"',t.value,'"']}),e.jsx("span",{style:{fontSize:12,color:"#9ba8b0",flex:1},children:t.action}),e.jsx("span",{style:{fontSize:10,padding:"2px 8px",borderRadius:4,background:t.color+"20",color:t.color},children:t.freq})]}),o===n&&e.jsxs("div",{style:{margin:"4px 0 8px 28px",padding:12,background:"#1c2333",borderRadius:8,border:`1px solid ${t.color}22`},children:[e.jsx("div",{style:{fontSize:13,lineHeight:1.6,color:"#9ba8b0",marginBottom:8},children:t.detail}),e.jsx(c,{children:t.code})]})]},n))}),e.jsx(a,{type:"exam",children:'For the exam, only two matter most: "tool_use" (continue) and "end_turn" (stop). The loop control is: while stop_reason == "tool_use": keep going. Everything else is edge cases.'})]})}function b(){const[o,s]=u.useState(null),i=[{id:"coord",label:"🎯 Coordinator",color:"#3B82F6",y:0,role:"Hub of hub-and-spoke. Decomposes tasks, delegates to subagents, aggregates results, checks quality gaps.",config:`allowedTools: ["Agent"]  # MUST include this — renamed from 'Task' in v2.1.63
agents: {
...
# It has an empty conversation.`})]}),e.jsxs("div",{style:{padding:14,background:"rgba(34,197,94,0.08)",borderRadius:10,border:"1px solid rgba(34,197,94,0.3)"},children:[e.jsx("div",{style:{fontSize:13,fontWeight:700,color:"#86efac",marginBottom:8},children:"✅ CORRECT — Explicit Context"}),e.jsx(c,{children:`synthesis_prompt = f"""
...
"""`})]})]}),e.jsxs(l,{title:"Structured Data Format for Context Passing",children:[e.jsx("div",{style:{fontSize:13,lineHeight:1.6,color:"#9ba8b0",marginBottom:8},children:"Separate content from metadata to preserve attribution across agents:"}),e.jsx(c,{children:`{
  "findings": [
    {
  ...
  "total_sources_reviewed": 15
}`})]}),e.jsx(a,{type:"exam",children:"When the synthesis subagent is missing citations from web search results even though the search agent returned them correctly, the root cause is almost always: the coordinator didn't pass the findings to the synthesis agent's prompt."})]})}function x(){const[o,s]=u.useState(0),i=[{title:"🚫 Block: Refund > $500",color:"#EF4444",steps:[{label:"Claude requests: process_refund($750)",bg:"rgba(59,130,246,0.08)"},{label:"⚡ PreToolUse hook fires (v2.0+) — can block, modify, or approve",bg:"rgba(245,158,11,0.08)"},{label:"Hook checks: $750 > $500 limit → DENY",bg:"rgba(239,68,68,0.08)"},{label:"Hook returns: permissionDecision: 'deny'",bg:"rgba(239,68,68,0.08)"},{label:"Claude receives: 'Exceeds limit. Use escalate_to_human'",bg:"rgba(239,68,68,0.08)"},{label:"Claude calls: escalate_to_human(summary) ✅",bg:"rgba(34,197,94,0.08)"}],code:`def pre_tool_hook(tool_name, tool_input, tool_use_id, ctx):
    ...
    return {"permissionDecision": "allow"}`},{title:"🔄 Normalize: Unix Timestamps → ISO 8601",color:"#10B981",steps:[{label:"Claude calls: get_order_status('ORD-789')",bg:"rgba(59,130,246,0.08)"},{label:"Tool returns: {created_at: 1705312200, status: 2}",bg:"#1c2333"},{label:"⚡ PostToolUse hook fires",bg:"rgba(245,158,11,0.08)"},{label:"Hook converts: 1705312200 → '2025-01-15T10:30:00Z'",bg:"rgba(245,158,11,0.08)"},{label:"Hook converts: status 2 → 'inactive'",bg:"rgba(245,158,11,0.08)"},{label:"Claude sees normalized data ✅",bg:"rgba(34,197,94,0.08)"}],code:`def post_tool_hook(tool_name, tool_result, tool_use_id, ctx):
    ...
    return {"result": json.dumps(result)}`},{title:"🔒 Prerequisite: Verify Customer Before Order Lookup",color:"#3B82F6",steps:[{label:"Claude requests: lookup_order('ORD-789')",bg:"rgba(59,130,246,0.08)"},{label:"⚡ PreToolUse hook fires",bg:"rgba(245,158,11,0.08)"},{label:"Hook checks: verified_customer_id is None → DENY",bg:"rgba(239,68,68,0.08)"},{label:"Claude calls: get_customer(email='jane@...')",bg:"rgba(59,130,246,0.08)"},{label:"⚡ PostToolUse stores: verified_customer_id = 'C-12345'",bg:"rgba(34,197,94,0.08)"},{label:"Claude retries: lookup_order with customer_id → ALLOW ✅",bg:"rgba(34,197,94,0.08)"}],code:`verified_customer_id = None
...
def post_tool_hook(tool_name, tool_result, tool_use_id, ctx):
    ...
    if tool_name == "get_customer":
        result = json.loads(tool_result)
        verified_customer_id = result.get("customer_id")`}],t=i[o];return e.jsxs(l,{title:"Agent SDK Hooks — Interactive Scenarios",children:[e.jsx("div",{style:{display:"flex",gap:6,marginBottom:12},children:i.map((n,r)=>e.jsx("button",{onClick:()=>s(r),style:{padding:"6px 12px",borderRadius:8,fontSize:12,fontWeight:600,cursor:"pointer",border:`2px solid ${o===r?n.color:"rgba(255,255,255,0.12)"}`,background:o===r?n.color+"15":"#161b22",color:o===r?n.color:"#9ba8b0"},children:n.title.split(":")[0]},r))}),e.jsx("div",{style:{fontSize:14,fontWeight:700,color:t.color,marginBottom:10},children:t.title}),e.jsx("div",{style:{display:"grid",gap:4,marginBottom:12},children:t.steps.map((n,r)=>e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[e.jsx("div",{style:{width:22,height:22,borderRadius:"50%",background:t.color+"20",border:`2px solid ${t.color}`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:10,fontWeight:700,color:t.color,flexShrink:0},children:r+1}),e.jsx("div",{style:{flex:1,padding:"6px 10px",borderRadius:6,background:n.bg,fontSize:12,color:"#9ba8b0",border:"1px solid rgba(255,255,255,0.12)"},children:n.label})]},r))}),e.jsx(c,{children:t.code}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginTop:12},children:[e.jsx(a,{type:"key",children:"PreToolUse: Fires BEFORE tool runs. Can block (deny), allow, modify input (updatedInput), or ask user. Use for enforcement, validation, redirection."}),e.jsx(a,{type:"key",children:"PostToolUse: Fires AFTER tool runs. Can normalize output, add context (additionalContext). Cannot undo actions. Use for data transformation, auditing."})]}),e.jsx(a,{type:"exam",children:"Hooks run in YOUR application process — they consume ZERO context window tokens. They are invisible to Claude. This makes them fundamentally different from prompt instructions."})]})}function _(){return e.jsxs(l,{title:"Programmatic Enforcement vs Prompt-Based Guidance",color:"#EF4444",children:[e.jsx(a,{type:"exam",children:"This is THE most tested concept in Domain 1. When the question mentions financial consequences, regulatory requirements, or compliance — the answer is ALWAYS programmatic hooks, never prompt-only."}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:12},children:[e.jsxs("div",{style:{padding:14,background:"rgba(34,197,94,0.08)",borderRadius:10,border:"2px solid #22C55E"},children:[e.jsx("div",{style:{fontSize:14,fontWeight:700,color:"#86efac",marginBottom:10},children:"✅ Hooks (Deterministic)"}),e.jsx("div",{style:{fontSize:12,color:"#86efac",lineHeight:1.6},children:"100% compliance rate. Physically impossible to bypass. Tool call is blocked before execution. Works regardless of prompt wording, context length, or model behavior."}),e.jsx("div",{style:{fontSize:12,fontWeight:600,color:"#86efac",marginTop:8},children:"Use for:"}),e.jsx("div",{style:{fontSize:12,color:"#86efac",lineHeight:1.6},children:"Identity verification before financial ops. Refund limits. PII handling. Regulatory compliance. Any rule that MUST be followed 100% of the time."})]}),e.jsxs("div",{style:{padding:14,background:"rgba(239,68,68,0.08)",borderRadius:10,border:"2px solid #EF4444"},children:[e.jsx("div",{style:{fontSize:14,fontWeight:700,color:"#f87171",marginBottom:10},children:"⚠️ Prompts (Probabilistic)"}),e.jsx("div",{style:{fontSize:12,color:"#fca5a5",lineHeight:1.6},children:"~88-95% compliance rate. Non-zero failure rate. Claude may skip instructions under certain contexts, long conversations, or ambiguous situations."}),e.jsx("div",{style:{fontSize:12,fontWeight:600,color:"#f87171",marginTop:8},children:"Use for:"}),e.jsx("div",{style:{fontSize:12,color:"#fca5a5",lineHeight:1.6},children:"Code style preferences. Best practices suggestions. Tone and formatting guidelines. Any rule where occasional non-compliance is acceptable."})]})]}),e.jsx(l,{title:"Decision Framework",children:e.jsx("div",{style:{display:"grid",gap:6},children:[{scenario:"Identity verification before refund",answer:"HOOKS",color:"#22C55E",why:"Financial consequences if skipped"},{scenario:"Block refunds > $500",answer:"HOOKS",color:"#22C55E",why:"Business rule requires 100% enforcement"},{scenario:"Prefer async/await over callbacks",answer:"PROMPT",color:"#3B82F6",why:"Style preference, not compliance"},{scenario:"Always use parameterized SQL queries",answer:"HOOKS",color:"#22C55E",why:"Security — SQL injection prevention"},{scenario:"Add JSDoc to public functions",answer:"PROMPT",color:"#3B82F6",why:"Best practice, not critical"},{scenario:"PII masking before logging",answer:"HOOKS",color:"#22C55E",why:"Regulatory requirement"}].map((o,s)=>e.jsxs("div",{style:{display:"flex",gap:10,padding:8,borderRadius:6,background:o.color+"08",border:`1px solid ${o.color}22`,alignItems:"center"},children:[e.jsx("span",{style:{fontSize:12,fontWeight:700,color:o.color,minWidth:60},children:o.answer}),e.jsx("span",{style:{fontSize:12,color:"#9ba8b0",flex:1},children:o.scenario}),e.jsx("span",{style:{fontSize:11,color:"#9ba8b0"},children:o.why})]},s))})})]})}function v(){return e.jsxs(l,{title:"Task Decomposition Strategies",children:[e.jsx(g,{steps:[{label:"Prompt Chaining",title:"Fixed Sequential Pipeline (Prompt Chaining)",color:"#3B82F6",content:"Steps are predetermined and predictable. Best for multi-aspect reviews where all steps are known in advance. Each step feeds its output to the next.",code:`# Code Review Pipeline (fixed sequence):
...
# ✅ Clear purpose, inputs, boundaries.`,why:"Tool descriptions are the #1 mechanism for selection. When they're minimal, Claude can't differentiate similar tools. The first fix is ALWAYS to expand descriptions."}];return e.jsxs(l,{title:"Anti-Patterns Reference (These ARE the Wrong Answers)",color:"#EF4444",children:[e.jsx("div",{style:{fontSize:13,color:"#9ba8b0",marginBottom:12},children:"Every anti-pattern below appears as a distractor (wrong answer) on the exam. Know WHY each is wrong."}),e.jsx("div",{style:{display:"grid",gap:12},children:o.map((s,i)=>e.jsxs("div",{style:{borderRadius:10,border:"1px solid rgba(255,255,255,0.12)",overflow:"hidden"},children:[e.jsxs("div",{style:{padding:"8px 14px",background:"#1c2333",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("div",{style:{fontSize:13,fontWeight:700,color:"#e0e0e0"},children:["⚠️ ",s.title]}),e.jsx("span",{style:{fontSize:10,padding:"2px 6px",borderRadius:4,background:"rgba(59,130,246,0.08)",color:"#93c5fd"},children:s.domain})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:0},children:[e.jsxs("div",{style:{padding:10,background:"rgba(239,68,68,0.08)",borderRight:"1px solid rgba(255,255,255,0.12)"},children:[e.jsx("div",{style:{fontSize:11,fontWeight:600,color:"#f87171",marginBottom:4},children:"❌ Wrong Pattern"}),e.jsx(c,{children:s.wrong})]}),e.jsxs("div",{style:{padding:10,background:"rgba(34,197,94,0.08)"},children:[e.jsx("div",{style:{fontSize:11,fontWeight:600,color:"#86efac",marginBottom:4},children:"✅ Correct Pattern"}),e.jsx(c,{children:s.right})]})]}),e.jsxs("div",{style:{padding:"8px 14px",background:"rgba(245,158,11,0.08)",fontSize:12,color:"#fcd34d"},children:[e.jsx("strong",{children:"Why:"})," ",s.why]})]},i))})]})}function w(){const[o,s]=u.useState("loop"),i={loop:e.jsx(h,{}),stop:e.jsx(f,{}),multi:e.jsx(b,{}),context:e.jsx(y,{}),hooks:e.jsx(x,{}),enforce:e.jsx(_,{}),decomp:e.jsx(v,{}),session:e.jsx(k,{}),anti:e.jsx(S,{})};return e.jsxs("div",{style:{fontFamily:"'Segoe UI', system-ui, sans-serif",maxWidth:780,margin:"0 auto",padding:"12px 10px",background:"#0d1117",color:"#e0e0e0",borderRadius:8},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:12},children:[e.jsx("h1",{style:{fontSize:18,fontWeight:800,color:"#e0e0e0",margin:0},children:"Domain 1: Agentic Architecture & Orchestration"}),e.jsx("div",{style:{fontSize:12,color:"#60a5fa",fontWeight:600},children:"27% of exam — Highest priority domain"})]}),e.jsx("div",{style:{display:"flex",gap:3,marginBottom:14,overflowX:"auto",paddingBottom:4},children:m.map(t=>e.jsx("button",{onClick:()=>s(t.id),style:{padding:"5px 8px",borderRadius:6,whiteSpace:"nowrap",fontSize:11,fontWeight:600,cursor:"pointer",border:`2px solid ${o===t.id?"#3B82F6":"rgba(255,255,255,0.12)"}`,background:o===t.id?"rgba(59,130,246,0.15)":"#161b22",color:o===t.id?"#60a5fa":"#9ba8b0"},children:t.label},t.id))}),e.jsx("div",{style:{background:"#161b22",borderRadius:16,border:"1px solid rgba(255,255,255,0.08)",padding:16},children:i[o]})]})}export{w as default};
